...
#### ロータリーエンコーダー
QWERTY配列では右手、大西配列では左手側に搭載することが出来ます。
|商品|数|備考|
|:-|:-|:-|
| EC12E2420301|×1||
...
### 3-1. ファームウェアについて
QWERTY配列と大西配列のファームウェアをそれぞれ用意しました。
発送時点では**QWERTY配列**のファームウェアを書き込んでいます。
...
to_〇〇レイヤーに居る間は〇〇キーが押された状態になります。推移と離脱を検知しています。
